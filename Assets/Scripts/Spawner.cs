...
public class Spawner : MonoBehaviour
{
    ...
    public List<GameObject> obstaclePrefabs; // Lista de prefabs de obst�culos
    ...
    void Update()
    {
        // Control de spawn de obst�culos
    ...
    void SpawnObject(List<GameObject> prefabs)
    {
        ...
        // Generar una posici�n aleatoria dentro del �rea definida
